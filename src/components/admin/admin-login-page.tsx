      ...
      <section className="relative w-full max-w-[430px] rounded-[28px] border border-white/70 bg-white/88 px-10 py-10 shadow-[0_24px_70px_rgba(15,23,42,0.16)] backdrop-blur-md">
        ...
        <form onSubmit={handleSubmit} className="mt-8 space-y-4">
          <label className="block">
            ...
            <span className="mt-2 flex h-10 items-center gap-2 rounded-xl border border-[#c8dbe5] bg-[linear-gradient(180deg,#fafdff_0%,#eefaf7_100%)] px-3 focus-within:border-[#2f66e7] focus-within:ring-4 focus-within:ring-cyan-100">
              <MailIcon className="h-4 w-4 text-[#4f7584]" />
              <input
                type="email"
                value={email}
                ...
                autoComplete="email"
                required
                className="w-full bg-transparent text-sm text-[#333846] outline-none placeholder:text-[#8ea0ab]"
              />
            </span>
          </label>
          ...
          <label className="block">
            ...
            <span className="mt-2 flex h-10 items-center gap-2 rounded-xl border border-[#c8dbe5] bg-[linear-gradient(180deg,#fafdff_0%,#eefaf7_100%)] px-3 focus-within:border-[#2f66e7] focus-within:ring-4 focus-within:ring-cyan-100">
              <LockIcon className="h-4 w-4 shrink-0 text-[#4f7584]" />
              <input
              ...
              <button
                ...
                className="shrink-0 text-[#6f8790] transition hover:text-[#2a5d68] focus:outline-none"
          ...
          <button
            ...
            className="mt-7 flex h-11 w-full cursor-pointer items-center justify-center gap-2 rounded-xl bg-[linear-gradient(135deg,#2563eb,#0ea5a6)] text-sm font-semibold text-white shadow-[0_16px_34px_rgba(37,99,235,0.24)] transition hover:brightness-105 disabled:cursor-not-allowed disabled:opacity-60"
          >
        ...
        <div className="mt-5 flex justify-center">
          <span className="inline-flex items-center gap-2 rounded-full border border-[#d7ebe7] bg-white/80 px-4 py-2 text-[11px] font-bold uppercase tracking-[0.08em] text-[#57727d] shadow-[0_8px_20px_rgba(14,165,166,0.08)]">
            <ShieldSmallIcon className="h-4 w-4 text-[#0f9f93]" />
